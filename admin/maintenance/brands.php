...
<script>
	$(document).ready(function(){
        ...
        $('#create_new').click(function(){
            uni_modal("Add New category","maintenance/manage_brand.php","mid-large")
        })
        $('.edit_data').click(function(){
            uni_modal("Add New category","maintenance/manage_brand.php?id="+$(this).attr('data-id'),"mid-large")
        })
