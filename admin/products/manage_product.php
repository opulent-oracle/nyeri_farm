	...
	<div class="card-body">
		<form action="" id="product-form">
            ...
            <div class="form-group">
				<label for="brand_id" class="control-label">Categories</label>
			...
			<div class="form-group">
				<label for="models" class="control-label">Planting Season: <small></small></label>
			...
			<div class="form-group">
				<label for="price" class="control-label">Price(per sack)</label>
